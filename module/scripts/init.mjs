...
Hooks.once("setup", () => {
    ...
    game.settings.register("illuminated-worlds-roller", "backgroundColor", {
        name: game.i18n.localize("IlluminatedWorldsRoller.backgroundColorName"),
        hint: game.i18n.localize("IlluminatedWorldsRoller.backgroundColorHint"),
        scope: "world",
        config: true,
        choices: {
    ...
    game.settings.register("illuminated-worlds-roller", "defaultStakes", {
        ...
        choices: {
            ...
            normal: game.i18n.localize("IlluminatedWorldsRoller.StakesNormal"),
            low: game.i18n.localize("IlluminatedWorldsRoller.StakesLow")
        },
        default: "normal"
    });
